# MiniNode app spec (specVersion 1)

> Paste this whole file into the AI tool that builds the app (Claude, Google AI Studio, …)
> together with your app idea. Apps that follow it deploy to MiniNode with zero rework.
> A shorter version for tools with small prompt limits is `NEW-APP-SPEC.short.md` (generated).
