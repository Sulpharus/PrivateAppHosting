...
Tokens live in `packages/ui`. Fonts: Bricolage Grotesque (display), Instrument Sans (text),
JetBrains Mono (code), all self-hosted. Light and dark mode are required. Touch targets are
at least 44 px and text meets WCAG AA contrast. Avoid gradients, emoji and generic
AI-looking layouts.
